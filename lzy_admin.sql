...
CREATE TABLE `wb_articlestype` (
  ...
  `whether_use` tinyint(1) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `wb_comments` (`comment_id`,`content`,`article_id`,`reply_id`,`ground_id`,`email`,`user_name`,`user_ip`,`create_date`,`head_img`,`deviceSystem`,`browserSystem`)  VALUES ('1','测试测试','26','0','0','1024327189@qq.com','lzyszds','广西梧州市','1712908551','/img/comments/NO.0001.jpg','Windows 10','Chrome123.0.0.0');
-- ----------------------------
...
INSERT INTO `wb_system_config` (`config_id`,`config_key`,`config_value`,`config_desc`)  VALUES ('5','load_animation_gif','/public/img/loadGif/loading11.gif','加载图片');
-- ----------------------------
